...
const GameForm = ({ onGameSubmit }) => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <input type="number" id="playingTime" value={playingTime} onChange={handlePlayingTimeChange} required/>

      <label htmlFor="minNumPlayers">Min Players:</label>
      <input type="number" id="minNumPlayers" value={minNumPlayers} onChange={handleMinNumPlayersChange} required/>

      <label htmlFor="maxNumPlayers">Max Players:</label>
      <input type="number" id="maxNumPlayers" value={maxNumPlayers} onChange={handleMaxNumPlayersChange} required/>
